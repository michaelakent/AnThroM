...
Participants who do not finish the task. The false belief is after the IDAQ and rating task or before the IDAQ.
```{r}
...
# 5. Rating task analysis {.tabset .tabset-fade .tabset-pills}
...
## 5. Control analysis 1 - situational anthropomorphism
...
## 5. Control analysis 2 - effectance
...
# 5. False belief analysis {.tabset .tabset-fade .tabset-pills}
...
Model 1 - test the relationship between situational and dispositional anthropomorphism and effectance:
```{r}
...
Model 2 - test the relationship between situational and dispositional anthropomorphism and false belief:
```{r}
