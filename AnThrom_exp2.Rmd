...
# 8. Analyses {.tabset .tabset-fade .tabset-pills}
...
## 8.4 Visualise data for distribution
```{r}
DF.exp2 %>%
...
## 8.5 Specify the formula and family for the models
...
## 8.6 Run full multivariate model
...
## 11.3 Full model effectance
```{r}
hdi_rope(modelef) 
```

## 11.4 Full  model false belief
```{r}
hdi_rope(modelfb) 
```

## 11.5 Winning  model effectance
```{r, eval = FALSE}
