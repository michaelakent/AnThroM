...
```{r, eval=FALSE}
modelC3 <- brm(formula = cent_sitant ~ cent_disant, 
      data = DF.exp2,
      family = gaussian,
      prior = priors1,
      chains = 4,
...
```{r, eval=FALSE}
modelC4 <-brm(formula = cent_effectance ~ cent_falsebelief, 
      data = DF.exp2,
      family = gaussian, 
      prior = priors1,
      chains = 4,
...
```{r, eval=FALSE}
model1fb <- brm(formula = cent_falsebelief ~ cent_sitant + cent_sitant2 + cent_disant + cent_disant2, 
      data = DF.exp2,
      family = gaussian,
      prior = priors1,
      chains = 4,
