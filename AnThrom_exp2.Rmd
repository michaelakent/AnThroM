...
p13 <- tom_combined_seen %>%
  ...
  geom_density(alpha = .5)+
  geom_vline(xintercept = 0, color = "black", linetype = 2) +
  ggtitle(paste("Posterior distributions for the original sample and first viewing only")) + 
  facet_wrap(model~dv) +
  theme(strip.background = element_blank()) +
  scale_fill_manual(values=c("#0072B2", "#000033", "#D55E00", "#660000")) 
p13

ggsave("experiment2/figures/S13.TIFF", plot = p13, width = 12, height = 5.08, units = "cm", dpi = 300)
```
