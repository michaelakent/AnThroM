...
p3
ggsave("experiment2/figures/1B.TIFF", plot = p3, width = 24.7, height = 8, units = "cm", dpi = 300)
...
p4b <- DF.fa %>%
  ...
  scale_y_continuous(name="accuracy on false belief trials (p)", limits=c(0, 1.1), breaks=c(0, 0.25, 0.5, 0.75, 1)) +
  theme(legend.position="none") +
  coord_fixed(ratio = 1/1) + 
  #ylim(0,1.1) +
  geom_hline(yintercept = 0.5, color = "grey", linetype = 2) + 
...
p4b
ggsave("experiment2/figures/1C.TIFF", plot = p4b, width = 24.7, height = 8, units = "cm", dpi = 300)
