...
```{r}
DF.rating <- DF.rating %>% 
  dplyr::group_by(prolific_id, measure, focus, event_type) %>% #focus and event_type are included or excluded based on Model C1/C2
...
## 8.2 Model 1 - anthropomorphism and effectance
...
## 8.3 Model 2 - anthropomorphism and false belief
