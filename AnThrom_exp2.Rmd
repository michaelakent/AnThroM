...
```{r, echo = TRUE, message=FALSE}
idaq <- read_csv("/Users/ruudhortensius/PsyCloud/Technician/1_AnThrom/Experiment_2/task/idaq_scale.csv") 

#load data (/Volumes/Project0255/dataset_1/sourcedata/)
DF.idaq  <- read_csv(file = "/Users/ruudhortensius/PsyCloud/Technician/1_AnThrom/Experiment_2/data/IDAQ_test.csv") %>%
