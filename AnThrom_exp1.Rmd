...
```{r, message=FALSE}
###
library("groundhog") #https://groundhogr.com/
groundhog.day="2020-02-19" 

###
groundhog.library("psych", groundhog.day)
groundhog.library("ordinal", groundhog.day)
groundhog.library("brms", groundhog.day)
groundhog.library("fs", groundhog.day)
groundhog.library("patchwork", groundhog.day) #devtools::install_github("thomasp85/patchwork")
groundhog.library("easystats", groundhog.day) #devtools::install_github("easystats/easystats")
groundhog.library("sjPlot", groundhog.day)
groundhog.library("httr", groundhog.day)
groundhog.library("kableExtra", groundhog.day)
groundhog.library("magrittr", groundhog.day)
groundhog.library("modelr", groundhog.day)
groundhog.library("ggdist", groundhog.day)
groundhog.library("tidybayes", groundhog.day)
groundhog.library("cowplot", groundhog.day)
groundhog.library("rstan", groundhog.day)
groundhog.library("ggrepel", groundhog.day)
groundhog.library("RColorBrewer", groundhog.day)
groundhog.library("gganimate", groundhog.day)
groundhog.library("see", groundhog.day)
...
## 9.6 HDI+ROPE using ggplot 
Based on [http://mjskay.github.io/tidybayes/articles/tidy-brms.html#posterior-predictions-kruschke-style-1]
