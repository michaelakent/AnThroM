...
## 1.1 Data
 ...
 Exp_1: Bangor Imaging Unit; EMBOTS; *n*=28; publication [Cross...Hortensius (2019) PTRB](https://royalsocietypublishing.org/doi/10.1098/rstb.2018.0034)  
...
--> Check if there are differences between the studies
...
```{bash}
/Users/soba/.local/bin/fmriprep-docker /Volumes/Project0245/data_exp2/ /Volumes/Project0245/data_exp2/derivatives participant --participant-label 01 02 03 04 05 06 07 08 09 10 --fs-license-file /Users/soba/license.txt --fs-no-reconall --skip_bids_validation --use-syn-sdc --use-aroma
```
