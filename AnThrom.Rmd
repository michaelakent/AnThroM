...
```{bash}
singularity run --cleanenv /analyse/Project0255/my_images/mriqc-0.14.2.simg /analyse/Project0255/dataset_2 /analyse/Project0255/dataset_2/derivatives participant --participant-label 201 -m T1w bold --ica --fft-spikes-detector -w /analyse/Project0255/work
```
...
Compare it across the datasets.
...
## 3.3 Theory-of-Mind event protocols 
