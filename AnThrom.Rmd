...
```{r}
library(tidyverse)
#"/Volumes/Project0255/dataset_1/sourcedata/
#load data
DF.d1  <- read_csv(file = paste("~/Desktop/anthrom/IDAQ_dataset1.csv", sep ="")) %>%
  gather("sub", "value", 4:32)

DF.d2  <- read_csv(file = paste("~/Desktop/anthrom/IDAQ_dataset2.csv", sep ="")) %>%
  gather("sub", "value", 4:38) 

DF.d3  <- read_csv(file = paste("~/Desktop/anthrom/IDAQ_dataset3.csv", sep ="")) %>%
  gather("sub", "value", 4:25) 

DF.d4  <- read_csv(file = paste("~/Desktop/anthrom/IDAQ_dataset4.csv", sep ="")) %>%
  gather("sub", "value", 4:25) 
...
roi_extract <- function(datasetno, substart, subend, network, nroi) {
  #/Volumes/Project0255
  dir_ls(paste("~/desktop/anthrom/dataset_", datasetno, "/derivatives/roi/", network, sep = ""), regexp = "\\.tsv$") %>% 
...
```{r}
#source("/Volumes/Project0255/code/R_rainclouds.R")
source("~/desktop/anthrom/R_rainclouds.R")
