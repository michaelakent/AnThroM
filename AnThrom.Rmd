...
library(brms)
fit1 <- brm(value ~ dataset + (1|itemnr) + (1|sub), 
            data = DF.test, family = "poisson", 
...
fit = fitted(fit1, newdata = newdata,, re_formula = NA)
