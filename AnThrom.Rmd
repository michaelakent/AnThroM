...
```{r}
library("rjson")
json_data <- fromJSON(file="/Volumes/Project0255/dataset_3/sub-301/fmap/sub-301_phasediff.json")
json_data$IntendedFor <- 'func/sub-301_task-movie_bold.nii.gz'
exportJson <- toJSON(json_data)
write(exportJson, "/Volumes/Project0255/dataset_3/sub-301/fmap/sub-301_phasediff.json")
