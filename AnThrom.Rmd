...
## 4.4 Pain Matrix fROI analysis
```{r}
#create variables
pain_rois <- c("AMCC","LINSULA","LMFG","LS2","RINSULA","RMFG","RS2")
#subject variables are the same as before
d1_subs <- c(101:129)
d2_subs <- c(203:235)
d3_subs <- c(301:322)
d4_subs <- c(401:422)
