...
```{bash}
docker run --rm -it -v /Volumes/Project0255/:/base nipy/heudiconv:latest -d /base/dataset_4/sourcedata/sub-{subject}/*.IMA -o /base/dataset_4 -f /base/code/heuristic_anthrom.py -s 412 -c dcm2niix -b --overwrite
```
...
for subj in 412 413 414 415 416 417 418 419 420 421 422; do
...
```{bash}
docker run -it --rm -v /Volumes/Project0255/dataset_4/:/data:ro -v /Volumes/Project0255/dataset_4/derivatives/mriqc:/out poldracklab/mriqc:0.14.2 /data /out participant --participant-label 411 -m T1w bold --ica --fft-spikes-detector 
```
...
library("tidyverse")
library("cowplot")
source("~/Documents/TOOLS/R_rainclouds.R")
