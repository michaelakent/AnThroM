...
```{r}
tom_combined <- bind_rows("rtpj" = as_tibble(as.mcmc(rtpj,  pars = c("b_cent_IDAQ", "b_cent_IDAQ2"), exact_match = TRUE ,combine_chains = TRUE)),
                                "ltpj" = as_tibble(as.mcmc(ltpj, pars = c("b_cent_IDAQ", "b_cent_IDAQ2"), exact_match = TRUE ,combine_chains = TRUE)),
                                "prec" = as_tibble(as.mcmc(prec, pars = c("b_cent_IDAQ", "b_cent_IDAQ2"), exact_match = TRUE ,combine_chains = TRUE)),
                                "vmpfc" = as_tibble(as.mcmc(vmpfc, pars = c("b_cent_IDAQ", "b_cent_IDAQ2"), exact_match = TRUE ,combine_chains = TRUE)),
                                "mmpfc" = as_tibble(as.mcmc(mmpfc, pars = c("b_cent_IDAQ", "b_cent_IDAQ2"), exact_match = TRUE ,combine_chains = TRUE)),
                                "dmpfc" = as_tibble(as.mcmc(dmpfc, pars = c("b_cent_IDAQ", "b_cent_IDAQ2"), exact_match = TRUE ,combine_chains = TRUE)),
                                .id = "roi")
...
```{r}
ggplot(data = posterior_combined, aes(x = b_cent_IDAQ2)) +
  geom_density()+
  geom_density(aes(x = b_cent_IDAQ))+
