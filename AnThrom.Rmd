...
#combine data
DF.full <- bind_rows(DF.dataset1, DF.dataset2, DF.dataset3, .id = "dataset") %>%
  group_by(dataset) %>%
...
```{bash}
singularity run --cleanenv /analyse/Project0255/my_images/fmriprep-1.5.2.simg /analyse/Project0255/dataset_2/ /analyse/Project0255/dataset_2/derivatives participant --participant-label sub-201 --fs-license-file /analyse/Project0255/my_images/license.txt --skip_bids_validation --fs-no-reconall --use-syn-sdc -w /analyse/Project0255/work/dataset_2
```
